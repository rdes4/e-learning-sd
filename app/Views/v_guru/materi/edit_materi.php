...
<h1 class="h3 mb-4 text-gray-800">Ubah Materi</h1>
    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                <form action="<?=base_url('detailguru/update_materi')?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control <?=($validation->hasError('judul_materi')) ? 'is-invalid' : '';?>" name="judul_materi" id="judul_materi" value="<?= $materi->judul_materi ?>"> 
                        <div class="invalid-feedback">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="isi_materi" id="isi_materi" rows="3"><?= $materi->isi_materi; ?></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control <?=($validation->hasError('link_video')) ? 'is-invalid' : '';?>" name="link_video" id="link_video" value="<?= $materi->link_video ?>"> 
                        <div class="invalid-feedback">
                            <?=$validation->getError('link_video')?>
                        </div>
                    </div>

                    <input type="hidden" name="file_uploads_lama" value="<?= $materi->file_uploads ?>">
                    ...
                    <button type="submit" class="btn btn-primary btn-add-siswa" name="edit"><i class="fas fa-edit"></i> Ubah Materi</button>

...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?=base_url()?>/datatables/Buttons-2.2.3/css/buttons.dataTables.min.css"/>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <?php elseif(session()->get('logGuru')) : ?>
            <!-- Heading -->
            <div class="sidebar-heading">
                MENU GURU
            </div>
            ...
            <!-- Nav Item - Pages Collapse Menu -->
            <li class="nav-item">
                <a class="nav-link" href="<?=base_url('detailguru/list_mapel')?>">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">  
                        ...
                        <?php elseif (session()->get('logGuru')) : ?>
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Guru : <?=session()->get('nama_guru')?></span>
                                <img class="img-profile rounded-circle"
                                    src="<?=base_url()?>/template/img/undraw_profile.svg">
                            </a>
                        <?php endif ?>
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <?php elseif (session()->get('logGuru')) : ?>
                                    <a class="dropdown-item" href="<?=base_url('auth/logoutGuru')?>">
                                        <i class="fas fa-sign-out-alt fa-sm fa-fw mr-2 text-gray-400"></i>
                                        Logout
                                    </a>
                                <?php endif ?>
...
<!-- Script CKEDITOR -->
    ...
    <!-- <script>
        CKEDITOR.replace( 'isi_tugas_siswa' );
    </script> -->
<!-- Script CKEDITOR -->
...
<!-- Script Datatables -->
        <script>
            $(document).ready( function () {
                $('#tabel_nilai_kuis_siswa').DataTable({
                    dom: 'Bfrtip',
                    buttons: [
                        {
                            extend: 'print',
